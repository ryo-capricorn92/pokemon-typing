...
var POWER = 0;
  ...
  //   stat: { // an object of the stat to be changed
  //     which: STRING // a string of the stat to change,
  //     raise: BOOL // a boolean representing whether to raise (true) to lower (false) the stat
  //   }
...
function Move (name, power, type, effects, message) {
  this.name = name;
  this.power = power;
  this.type = type;
  this.effects = effects;
  if (this.effects && this.effects.stat && !this.effects.stat[1]) {
    this.effects.stat = [this.effects.stat];
  }
  this.message = message;
}

pokemonMoves.move["tackle"] = new Move ("tackle", 40, "normal", null);
pokemonMoves.move["growl"] = new Move ("growl", POWER, "normal", { target: true, stat: { which: 'attack', raise: false }, factor: 1 });
...
pokemonMoves.move["growth"] = new Move ("growth", POWER, "normal", { target: false, stat: { which: 'attack', raise: true } });
...
pokemonMoves.move["scary face"] = new Move ("scary face", POWER, "normal", { target: true, stat: { which: 'speed', raise: false }, factor: 2 });
...
pokemonMoves.move["tail whip"] = new Move ("tail whip", POWER, "normal", { target: true, stat: { which: 'attack', raise: false }, factor: 1 });
pokemonMoves.move["water gun"] = new Move ("water gun", 40, "water", null);
pokemonMoves.move["withdraw"] = new Move ("withdraw", POWER, "water", { target: false, stat: { which: 'defense', raise: true }, factor: 1 });
pokemonMoves.move["bubble"] = new Move ("bubble", 40, "water", { target: true, stat: { which: 'speed', raise: false }, factor: 1, chance: 0.1 });
...
pokemonMoves.move["skull bash"] = new Move ("skull bash", 130, "normal", { target: false, stat: { which: 'attack', raise: true }, factor: 1, wait: { turns: 2, attackOn: 2 } });
pokemonMoves.move["iron defense"] = new Move ("iron defense", POWER, "steel", { target: false, stat: { which: 'attack', raise: true }, factor: 2 });
pokemonMoves.move["rain dance"] = { name: "rain dance", notUsed: true }
pokemonMoves.move["hydro pump"] = new Move ("hydro pump", 110, "water", null);
pokemonMoves.move["flash cannon"] = new Move ("flash cannon", 80, "steel", { target: true, stat: { which: 'attack', raise: false }, factor: 1, chance: 0.1 });
...
pokemonMoves.move["leer"] = new Move ("leer", POWER, "normal", { target: true, stat: { which: 'defense', raise: false }, factor: 1 });
...
pokemonMoves.move["defense curl"] = new Move ("defense curl", POWER, "normal", { target: false, stat: { which: 'attack', raise: true }, factor: 1 });
pokemonMoves.move["flame charge"] = new Move ("flame charge", 50, "fire", { target: false, stat: { which: 'speed', raise: true }, factor: 1 });
...
pokemonMoves.move["crunch"] = new Move ("crunch", 80, "dark", { target: true, stat: { which: 'attack', raise: false }, factor: 1, chance: 0.2 });
pokemonMoves.move["chip away"] = new Move ("chip away", 70, "normal", null, "still needs ignorance of user's stat changes");
pokemonMoves.move["screech"] = new Move ("screech", POWER, "normal", { target: true, stat: { which: 'attack', raise: false }, factor: 2 });
pokemonMoves.move["thrash"] = new Move ("thrash", 120, "normal", { target: true, wait: { turns: 3, attackOn: "all", afflictionOn: 3 } });
pokemonMoves.move["superpower"] = new Move ("superpower", 120, "fighting", { target: false, stat: [ { which: 'attack', raise: false }, { which: 'attack', raise: false } ], factor: 1 });
pokemonMoves.move["agility"] = new Move ("agility", POWER, "normal", { target: false, stat: { which: 'speed', raise: true }, factor: 2 });
...
pokemonMoves.move["energy ball"] = new Move ("energy ball", 90, "grass", { target: true, stat: { which: 'attack', raise: false }, factor: 1, chance: 0.1 });
...
pokemonMoves.move["leaf storm"] = new Move ("leaf storm", 130, "grass", { target: false, stat: { which: 'attack', raise: false }, factor: 2 });
...
pokemonMoves.move["bulk up"] = new Move ("bulk up", POWER, "fighting", { target: false, stat: [ { which: 'attack', raise: true }, { which: 'attack', raise: true } ], factor: 1 });
...
pokemonMoves.move["mud shot"] = new Move ("mud shot", 55, "ground", { target: true, stat: { which: 'speed', raise: false }, factor: 1 });
...
pokemonMoves.move["hammer arm"] = new Move ("hammer arm", 100, "fighting", { target: false, stat: { which: 'speed', raise: false }, factor: 1 });
pokemonMoves.move["curse"] = new Move ("curse", POWER, "ghost", { target: false, stat: [ { which: 'attack', raise: true }, { which: 'attack', raise: true }, { which: 'speed', raise: false } ], factor: 1 });
...
pokemonMoves.move["nasty plot"] = new Move ("nasty plot", POWER, "dark", { target: false, stat: { which: 'attack', raise: true }, factor: 2 });
...
pokemonMoves.move["close combat"] = new Move ("close combat", 120, "fighting", { target: false, stat: { which: 'attack', raise: false }, factor: 1 });
pokemonMoves.move["punishment"] = { name: "punishment", notUsed: true };
pokemonMoves.move["calm mind"] = new Move ("calm mind", POWER, "psychic", { target: false, stat: [ { which: 'attack', raise: true }, { which: 'attack', raise: true } ], factor: 1 });
pokemonMoves.move["water sport"] = { name: "water sport", notUsed: true };
pokemonMoves.move["bubblebeam"] = new Move ("bubblebeam", 65, "water", { target: true, stat: { which: 'speed', raise: false }, factor: 1, chance: 0.1 });
...
pokemonMoves.move["metal claw"] = new Move ("metal claw", 50, "steel", { target: false, stat: { which: 'attack', raise: true }, factor: 1, chance: 0.1 });
pokemonMoves.move["swords dance"] = new Move ("swords dance", POWER, "normal", { target: false, stat: { which: 'attack', raise: true }, factor: 2 });
pokemonMoves.move["swagger"] = new Move ("swagger", POWER, "normal", { target: false, stat: { which: 'attack', raise: true }, factor: 2, affliction: "confused" });
...
pokemonMoves.move["coil"] = new Move ("coil", POWER, "poison", { target: false, stat: [ { which: 'attack', raise: true }, { which: 'attack', raise: true } ], factor: 1 });
...
pokemonMoves.move["razor shell"] = new Move ("razor shell", 75, "water", { target: true, stat: { which: 'attack', raise: false }, factor: 1, chance: 0.5 });
...
pokemonMoves.move["howl"] = new Move ("howl", POWER, "normal", { target: false, stat: { which: 'attack', raise: true }, factor: 1 });
...
pokemonMoves.move["psychic"] = new Move ("psychic", 90, "psychic", { target: true, stat: { which: 'attack', raise: false }, chance: 0.1 });
...
pokemonMoves.move["shadow ball"] = new Move ("shadow ball", 80, "ghost", { target: true, stat: { which: 'attack', raise: false }, chance: 0.2 });
pokemonMoves.move["mystical fire"] = new Move ("mystical fire", 75, "fire", { target: true, stat: { which: 'attack', raise: false }, factor: 1 });
...
pokemonMoves.move["feather dance"] = new Move ("feather dance", POWER, "flying", { target: true, stat: { which: 'attack', raise: false }, factor: 2 });
...
pokemonMoves.move["baby-doll eyes"] = new Move ("baby-doll eyes", POWER, "fairy", { target: true, stat: { which: 'attack', raise: false }, factor: 1 });
...
pokemonMoves.move["moonblast"] = new Move ("moonblast", 95, "fairy", { target: true, stat: { which: 'attack', raise: false }, chance: 0.3, factor: 1 });
pokemonMoves.move["captivate"] = new Move ("captivate", POWER, "TYPE", { target: true, stat: { which: 'attack', raise: false }, factor: 2 }, "still needs check to only trigger when pokemon is opposite gender");
